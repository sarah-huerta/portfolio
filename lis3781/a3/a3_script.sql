...
insert into customer values (seq_cus_id.nextval, 'Minnie','Mouse', '123 Main st','Orlando', 'FL',32310,8508960561,'minnie@magic.com', 12323.99, 'Purchaser for Company');
insert into customer values (seq_cus_id.nextval, 'Mickey','Mouser', '234 Pixar Dr', 'Orlando', 'FL',32311,1234567890,'mickey@magic.com', 232.99,NULL);
insert into customer values (seq_cus_id.nextval, 'Daisy','Duck', '345 Sunset Blvd', 'Orlando', 'FL', 32312,8970695843,'daisy@magic.com',433.48, 'Repeat Cusomter');
insert into customer values (seq_cus_id.nextval, 'Donlad','Ducker', '456 Muppets Dr', 'Orlando', 'FL',32313,9384738345,'donlad@magic.com',342.99, NULL);
insert into customer values (seq_cus_id.nextval, 'Goofy','Goof', '567 Castle Ln ', 'Orlando', 'FL',32314,2839405943, 'goofy@magic.com', 35439.39, 'Reckless spender');
commit;
